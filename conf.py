...
BLOG_AUTHOR = "A. Coady"  # (translatable)
BLOG_TITLE = "Pythonicity"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://coady.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://coady.github.io/"
BLOG_EMAIL = "aric.coady@gmail.com"
BLOG_DESCRIPTION = "the quality of being Pythonic"  # (translatable)
...
CATEGORY_TITLES = {
   DEFAULT_LANG: {
       "puzzles": "Posts about solving puzzles programmatically",
       "interviews": "Posts about common interview questions",
       "style": "Posts about style and conventions",
   },
}
